...
Route::group(['prefix'  =>  'admin'], function () {
    ...
    Route::group(['middleware' => ['auth:admin']], function () {
        ...
        Route::group(['prefix' => 'roles'], function () {
            ...
            Route::get('/', 'Admin\RolController@index')->name('admin.roles.index');
            Route::get('/create', 'Admin\RolController@create')->name('admin.roles.create');
            Route::post('/store', 'Admin\RolController@store')->name('admin.roles.store');
            Route::get('/{id}/edit', 'Admin\RolController@edit')->name('admin.roles.edit');
            Route::post('/update', 'Admin\RolController@update')->name('admin.roles.update');
            Route::post('destroy', 'Admin\RolController@destroy')->name('admin.roles.destroy');   
         });
         Route::group(['prefix' => 'users'], function () {
            
            Route::get('/', 'Admin\AdminController@index')->name('admin.users.index');
            Route::get('/create', 'Admin\AdminController@create')->name('admin.users.create');
            Route::post('/store', 'Admin\AdminController@store')->name('admin.users.store');
            Route::get('/{id}/edit', 'Admin\AdminController@edit')->name('admin.users.edit');
            Route::post('/update', 'Admin\AdminController@update')->name('admin.users.update');
            Route::post('destroy', 'Admin\AdminController@destroy')->name('admin.users.destroy');   
         });
         Route::group(['prefix' => 'clients'], function () {
            Route::get('/', 'Admin\ClientController@index')->name('admin.clients.index'); 
         });
    });
});
