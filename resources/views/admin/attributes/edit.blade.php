        ...
        <div class="col-md-3">
            <div class="tile p-0">
                <ul class="nav flex-column nav-tabs user-tabs">
                    ...
                    <li class="nav-item"><a class="nav-link" href="#values" data-toggle="tab">Valores de los atributos</a></li>
                </ul>
            </div>
        </div>
        <div class="col-md-9">
                ...
                <div class="tab-pane active" id="general">
                    <div class="tile">
                        <form action="{{ route('admin.attributes.update') }}" method="POST" role="form">
                            @csrf
                            <h3 class="tile-title">Información</h3>
                            <hr>
                            <div class="tile-body">
                            ...
                            <div class="tile-footer">
                                <div class="row d-print-none mt-2">
                                    <div class="col-12 text-right">
                                        <button class="btn btn-success" type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i>Actualizar</button>
                                        <a class="btn btn-danger" href="{{ route('admin.attributes.index') }}"><i class="fa fa-fw fa-lg fa-arrow-left"></i>Guardar</a>
                                    </div>
                                </div>
                            </div>
                        </form>
