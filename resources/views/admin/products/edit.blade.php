                                    ...
                                    {{-- <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input
                                                class="form-control"
                                                type="text"
                                                placeholder="Ingresar precio especial"
                                                id="sale_price"
                                                name="sale_price"
                            ...
                            <div class="row d-print-none mt-2">
                                <div class="col-12 text-right">
                                    <button class="btn btn-success" type="button" id="uploadButton">
                                        <i class="fa fa-fw fa-lg fa-upload"></i>Subir Imagen
                                    </button>
                                </div>
                            </div>
                            @if ($product->images)
    ...
    <script>
        ...
        $( document ).ready(function() {
            ...
            myDropzone.on("queuecomplete", function (file) {
                ...
                showNotification('Completed', 'Imagenes cargadas correctamente', 'success', 'fa-check');
            });
            $('#uploadButton').click(function(){
                if (myDropzone.files.length === 0) {
                    showNotification('Error', 'Seleccionar productos a subir.', 'danger', 'fa-close');
                } else {
