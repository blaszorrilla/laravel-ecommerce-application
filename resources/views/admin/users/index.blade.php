...
@section('content')
    <div class="app-title">
        <div>
         ...
         <a href="{{url('listarUsuariosPdf')}}" target="_blank">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group" role="group" aria-label="Second group">
                                            <a href="{{ route('admin.users.edit', $admin->id) }}" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i></a>
                                            </div>
                                        </td>
                                             <td>  
                                            @if($admin->status=="ACTIVO")

                                                <button type="button" class="btn btn-danger btn-sm" data-id="{{$admin->id}}" data-toggle="modal" data-target="#cambiarEstado">
                                                    <i class="fa fa-times fa-2x"></i> Desactivar
                                                </button>

                                                @else

                                                <button type="button" class="btn btn-success btn-sm" data-id="{{$admin->id}}" data-toggle="modal" data-target="#cambiarEstado">
                ...
                <div class="modal-dialog modal-primary modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{route('users.destroy','test')}}" method="post" enctype="multipart/form-data" class="form-horizontal">
                                  {{method_field('delete')}}
